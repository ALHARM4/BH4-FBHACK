    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.facebook.com/profile.php?id=100049331647083')
                time.sleep(2)
                menu()
